    ...
    <div className="min-h-screen flex flex-col items-center bg-primary  text-dark">
      ...
      <div className="bg-no-repeat bg-center bg-cover w-full" style={{backgroundImage: "url('/images/111.png')"}}>
        ...
        <div className="flex flex-row items-center justify-center gap-4 text-white  xl:text-2xl  md:text-xl sm:text-xl mb-20">
          ...
          <button
            className="xl:w-[300px] sm:w-[240px] bg-[#183a4d] hover:bg-[#132c3e]  font-semibold py-5 rounded-3xl transition-all duration-300 ease-in-out transform hover:scale-105 active:scale-95 focus:ring-4 focus:ring-[#183a4d]/50"
          >
            BOOK A CONSULT
          </button>
        </div>
        ...
        <div className="container bg-secondary w-full  px-6 py-10 shadow-md grid grid-cols-3 gap-6">
          <div className="flex flex-col items-center">
            ...
            <p className="text-lg">
              Our restaurant profit designer is a smart tool that helps you plan and
              optimize your restaurant's profitability. With our designer, you can
          ...
          <div className="flex flex-col items-center">
            <h2 className="xl:text-2xl sm:text-xl font-bold mb-2 flex items-center gap-2">
              ...
              WHAT IT SOLVES? </h2>
            <p className="text-lg">Our Restaurant Revenue designer solves a critical problem for both new and existing restaurant owners: uncertainty in financial planning.
          ...
          <h2 className="xl:text-2xl sm:text-xl font-bold mb-2 flex items-center gap-2">
              ...
              HOW IT WORKS? </h2>
            <p className="text-lg">Simply enter key details like your restaurant's seating capacity, average customer spend, and monthly expenses into the designer. The tool instantly generates your projected annual revenue, profit estimates, and break-even year with easy-to-read results</p>
          </div>
        </div>
      {/* Pricing Cards */}
      ...
      <div className="container  py-8 2xl:px-28 lg:px-8 md:px-40 sm:px-30 ">
        ...
        <h2 className="xl:text-5xl  md:text-3xl sm:text-2xl font-bold mb-1">Basic</h2>
          ...
          <ul className="list-disc list-inside  2xl:text-xl xl:text-lg sm:text-md mb-5 space-y-1 text-left ">
          ...
          <button className="rounded border-2 border-dark mt-auto inline-block px-5  overflow-hidden xl:text-2xl  md:text-xl sm:text-lg font-bold transition-transform rounded-full group hover:bg-[#CD8D7A] hover:text-dark">
        ...
        <h2 className="xl:text-5xl  md:text-3xl sm:text-2xl font-bold mb-1">Premium</h2>
          ...
          <button className="rounded border-2 border-dark mt-auto inline-block px-5  overflow-hidden xl:text-2xl  md:text-xl sm:text-lg font-bold transition-transform rounded-full group hover:bg-[#FFF67E] hover:text-dark">
        ...
        <div className="flex-1 bg-[#1d4d3a] rounded-xl py-10 px-8 flex flex-col items-center shadow-lg shadow-[#0c1425]/50 min-w-[260px] w-full mx-auto text-[#f8faf5] transition duration-300 ease-in-out hover:scale-105 hover:shadow-2xl">
          ...
          <button className="rounded border-2 border-dark mt-auto inline-block px-5  overflow-hidden xl:text-2xl  md:text-xl sm:text-lg font-bold transition-transform rounded-full group hover:bg-[#40A578] hover:text-dark">
